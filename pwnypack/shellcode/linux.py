...
class Linux(BaseEnvironment):
    ...
    sys_mmap_pgoff = SyscallDef('sys_mmap_pgoff', NUMERIC, NUMERIC, NUMERIC, NUMERIC, NUMERIC, NUMERIC)  #:
    sys_old_mmap = SyscallDef('sys_old_mmap', PTR)  #:
    ...
    def syscall(self, op):
        ...
        return code + \
            ...
            [self.SYSCALL_INSTR], self.SYSCALL_REG
